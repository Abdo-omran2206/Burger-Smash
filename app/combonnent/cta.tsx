...
function CTA(){
    return(
        <div className="bg-[url(/prev/chef-holding-juicy-beef-burger.jpg)] bg-no-repeat bg-[length:100%_auto] bg-top w-full h-full flex justify-center items-center">
            <div className="h-full w-full bg-black/50 flex justify-center items-center">
                <div className="text-center flex flex-col gap-10 items-center">
                    ...
                    viewport={{once:true}}
                    className="text-5xl">Get your order now — and smash your hunger.</motion.h2>
                    <motion.button 
